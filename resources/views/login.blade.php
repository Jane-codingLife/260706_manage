						...
						<div class="login-form">
							...
							<form method="post" action="{{route('checkId')}}">
								...
								<div class="form-group">
									<label>帳號</label>
									<input type="text" name="usrAccount" value="{{old('usrAccount')}}" class="form-control" placeholder="帳號">
								</div>
								<div class="form-group">
									<label>密碼</label>
									<input type="password" name="usrPassword" value="{{old('usrPassword')}}" class="form-control" placeholder="密碼">
								</div>
								<div>
									<label>
										@if($errors->any())
